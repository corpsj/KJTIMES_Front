    ...
    <div className="admin2-grid">
      <aside>
        ...
        <div className="admin2-panel">
          ...
          <div className="admin2-queue">
            <Link className="admin2-btn admin2-btn-ink" href="/admin2/write">
              긴급 기사 작성
            </Link>
              ...
              stats.recentArticles.map((article) => (
                <div key={article.id} className="admin2-row">
                  ...
                  <div className="admin2-status-column">
                    <span className={`admin2-tag admin2-tag--${article.status === "published" ? "published" : article.status === "pending_review" ? "pending" : "draft"}`}>
                      {article.status === "published" ? "게시" : article.status === "pending_review" ? "대기" : "작성"}
                    </span>
                  </div>
