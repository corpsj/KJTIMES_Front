      ...
      <Stack gap="xl">
        ...
        <Box>
          ...
          <Text c="dimmed" style={{ lineHeight: 1.8 }}>
            본 약관은 광전타임즈(이하 "회사")가 제공하는 인터넷 뉴스 서비스(이하 "서비스")의 이용과 관련하여
        ...
        <Box>
          ...
          <Text c="dimmed" style={{ lineHeight: 1.8 }}>
            1. "서비스"란 회사가 제공하는 인터넷 뉴스 및 관련 서비스를 의미합니다.<br />
            2. "이용자"란 본 약관에 따라 회사가 제공하는 서비스를 이용하는 회원 및 비회원을 말합니다.<br />
            3. "회원"이란 회사와 서비스 이용계약을 체결하고 회원 아이디(ID)를 부여받은 자를 말합니다.<br />
