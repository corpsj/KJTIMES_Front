        ...
        <Box component="section" className={styles.chosunDesktopWrap}>
            <Container size={1220} className={styles.chosunDesktopContainer}>
                <Grid gutter={22} align="flex-start">
                    {/* Main content column - full width on mobile, 8/12 on desktop */}
                    <GridCol span={{ base: 12, md: 8 }}>
                        <article className={styles.chosunArticlePane}>
                            {/* Mobile breadcrumb - visible only on mobile */}
                            <Text size="xs" className={styles.mobileBreadcrumb} hiddenFrom="md">
                    ...
                    {/* Sidebar - visible only on desktop (md and up) */}
